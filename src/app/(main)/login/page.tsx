        ...
        <div className="flex flex-col w-[75%] h-[70%]">
            ...
            <div className="flex flex-col justify-evenly h-[50%] w-[50%] m-auto">
                ...
                <label className="flex items-center space-x-3 cursor-pointer">
                    <input 
                        type="checkbox"
                        className="w-[2rem] h-[2rem] rememberMe text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                    />
                    <span className="text-[2rem] text-gray-600 select-none">Запомнить меня</span>
                </label>
            </div>
